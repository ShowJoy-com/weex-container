...
-(void)openUrl:(UIViewController *)controller url:(NSString *)url force:(BOOL)force{
    ...
    [mweexVC SHloadWeexPageWithData:mdicSentValue withRelease:[self isRelease] withController:controller];
...
-(NSArray*)requestWeexConfig{
    NSDictionary * mdicvalue = [NSDictionary dictionaryWithObjectsAndKeys:@"",@"h5",@"http://ocr4ojfnd.bkt.clouddn.com/foo.js",@"url",@"login",@"page",@"1.0.0",@"v",@"",@"md5",@"false",@"hideTitleBar", nil];
